...
extension CAGradientLayer {
    ...
    func reverseRoseWaterColor() -> CAGradientLayer{
        let topColor = UIColor(red: 229/255.0, green: 93/255.0, blue: 135/255.0, alpha: 1)
        let bottomColor = UIColor(red: 95/255.0, green: 195/255.0, blue: 228/255.0, alpha: 1)
